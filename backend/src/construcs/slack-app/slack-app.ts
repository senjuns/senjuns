...
export class SlackApp extends Construct {
  ...
  constructor(scope: Construct, id: string, props: SlackAppProps) {
    ...
    this.credentials =
      ...
      new secretsmanager.Secret(this, 'Credentials', {
    ...
    this.clientSecret = this.credentials
      .secretValueFromJson('clientSecret')
      .toString();
    this.verificationToken = this.credentials
      .secretValueFromJson('verificationToken')
      .toString();
    this.signingSecret = this.credentials
      .secretValueFromJson('signingSecret')
      .toString();
  }
}
