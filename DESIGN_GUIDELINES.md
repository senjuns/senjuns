...
AWS services are modeled around the concept of _resources_. Services normally
...
Construct props should expose the _full set_ of capabilities of the AWS service
