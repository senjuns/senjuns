...
AWS_APPSYNC_GRAPHQLENDPOINT=$(echo $RESPONSE | jq -r '.aws_appsync_graphqlEndpoint')
...
sed -i'.bak' 's#AWS_APPSYNC_GRAPHQLENDPOINT#'$AWS_APPSYNC_GRAPHQLENDPOINT'#g' $CONFIG_FILE_REPLACED
