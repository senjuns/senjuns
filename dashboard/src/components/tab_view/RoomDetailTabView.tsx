...
const RoomDetailTabView: React.FC<RoomDetailTabViewProps> = ({
  ...
  const { statistics, updatedTime } = useRoomOverview();

  const measurementCards = useMeasurementCards(statistics);
      ...
      <MainSection>
        ...
        <TabContainer id="room-detail-tab-container">
          <TabHeader>
            ...
            {isPhotoSectionView && currentTab === ROOM_DETAIL_TABS.PHOTO_FEED && (
